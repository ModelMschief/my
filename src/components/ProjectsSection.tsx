...
const projects = [
  {
    title: 'BSC Payment Gateway',
    description: 'Fully non-custodial Binance Smart Chain (BSC) payment gateway. Features direct node communication (no third-party APIs) and seamless integration with Telegram.',
    tags: ['Python', 'BSC', 'Blockchain', 'Telegram'],
    category: 'Blockchain',
    icon: '💸',
  ...
  },
  {
    ...
    description: 'Custom modular RAG library with highly flexible AI architectures. Built for reusability, abstracting retrieval complexity while keeping the pipeline transparent.',
    tags: ['Python', 'LLM', 'Vector Search', 'RAG'],
    category: 'AI Framework',
    icon: '🧠',
    gradient: 'from-purple-500 via-pink-500 to-red-500',
  },
  {
    title: 'TON Crypto Lib',
    description: 'Developer-facing library for integrating TON blockchain payments into Python applications. Reduces integration surface area for Telegram-native payment flows.',
    tags: ['Python', 'TON', 'Blockchain', 'API'],
    category: 'Library',
    icon: '💎',
    gradient: 'from-cyan-500 via-blue-500 to-indigo-500',
  },
  {
    title: 'API Provider Platform',
    description: 'A multi-provider API gateway prototype hosting ~5 specialized APIs. Features a multi-server architecture utilizing Flask for Machine Learning services and Redis for caching.',
    tags: ['FastAPI', 'Flask', 'Machine Learning', 'Redis'],
    category: 'Backend',
    icon: '⚡',
    gradient: 'from-green-500 via-emerald-500 to-teal-500',
  },
  {
    title: 'Telegram Payment Automation',
    description: 'Comprehensive automation systems built on the Telegram Bot API — handling notification pipelines, MongoDB integrations, and automated payment workflows.',
